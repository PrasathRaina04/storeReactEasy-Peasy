...
<button className="text-muted" onClick={()=>setShowSignUp(true)}>Signup</button>
</div>
                </div>
            </div>
        </div>
    
    {showSignUp &&   <div className="modal fade show" id="modal-1" role="dialog" tabindex="-1" style={{ display:"block", }}>
